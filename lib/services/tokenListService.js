// Lista estática de tokens por chain (node-cache removido — serverless stateless)
// Para tokens dinâmicos, use a rota /api/data/top-coins que usa Vercel Edge Cache.
...
// Top tokens estáticos por chain
const STATIC_TOKEN_LISTS = {
  ethereum: [
    ...
    { address: '0x7f39C581F595B53c5cb19bD0b3f8dA6c935E2Ca0', coingeckoId: 'wrapped-steth' },
    { address: '0x7Fc66500c84A76Ad7e9c93437bFc5Ac33E2DDaE9', coingeckoId: 'aave' },
    // Aave V3 Ethereum aTokens
    { address: '0x23878914EFE38d27C4D67Ab83ed1b93A74D4086a', coingeckoId: 'tether' },
    { address: '0x98C23E9d8f34FEFb1B7BD6a91B7FF122F4e16F5c', coingeckoId: 'usd-coin' },
    { address: '0x018008bfb33d285247A21d44E50697654f754e63', coingeckoId: 'dai' },
    { address: '0x5Ee5bf7ae06D1Be5997A1A72006FE6C607eC6DE8', coingeckoId: 'wrapped-bitcoin' },
    { address: '0x4d5F47FA6A74757f35C14fD3a6Ef8E3C9BC514E8', coingeckoId: 'weth' },
    { address: '0xA700b4eB416Be35b2911fd5Dee80678ff64fF6C9', coingeckoId: 'aave' },
  ],
  arbitrum: [
...
/**
 * Retorna lista de tokens para uma chain.
 * Usa lista estática — sem cache em memória (serverless).
 */
export function getTopTokens(chainId) {
  return STATIC_TOKEN_LISTS[chainId] || [];
}
